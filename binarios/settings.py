"""
Django settings for binarios project.
...
SECRET_KEY = 'django-insecure-i+uq2#tiwbu36773_mix4_anat#&z$=th#22uq1_%qy&f3q04y'
...
WSGI_APPLICATION = 'binarios.wsgi.application'
